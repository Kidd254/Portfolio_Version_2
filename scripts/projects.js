...
const projectArr = [
  ...
  },
  {
    ...
    description:
      'An app created using Python and Django. It can also allow users to create courses and also manage the topics under every course. Users can use it to keep track of their tech learning process.',
